...
3. **Easy Integration**: With our WordPress compatible solution, you can swiftly and effortlessly integrate the plugin into your online shop.
...
These key features make the OLS Recommendations Plugin a powerful solution for enhancing customer experience and boosting sales in your online shop.

== Installation ==

This section describes how to install the plugin and get it working.

### Install NextBestOffer-OLS from within wordpress
1. Visit the plugins page within your dashboard and select ‘Add New’;
1. Search for ‘NextBestOffer-OLS’;
1. Activate NextBestOffer-OLS from your Plugins page;

### Install NextBestOffer-OLS manually
1. Upload `NextBestOffer-OLS.zip` to the `/wp-content/plugins/` directory
